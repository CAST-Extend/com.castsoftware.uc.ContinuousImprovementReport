...
'appName ="Report_Dev"
'csvDate="201907181711" 'CStr(Year(Now)) & CStr(Month(Now)) & CStr(Day(Now)) & Cstr(Hour(Now))& Cstr(Minute(Now))
'path = "C:\Continuous Improvement"
'logpath="C:\Continuous Improvement"
'reportpath="C:\Continuous Improvement"
'=============================================================================================================
'================================================EXECUTION====================================================
'=============================================================================================================
...
Public Const CSV1_PRIO_COL_ID = "G"
Public Const CSV1_NV_COL_ID = "E"
Public Const CSV1_LAST_COL_ID = "I"
...
On Error Resume Next
    ...
    If openFile(CSVFilePath) Then
		With XLAPP.Workbooks(CSVFileName).ActiveSheet.UsedRange
...
On Error Resume Next
	...
	With XLAPP.Workbooks(FileName).ActiveSheet	
		If IsFirstSheet Then
			...
			'order by rule priority then by nb new violations
			.Sort.SortFields.Add .range(CSV1_PRIO_COL_ID & "1",CSV1_PRIO_COL_ID & lastRow), xlSortOnValues, xlAscending , "extreme,high,moderate,low", xlSortNormal
			.Sort.SortFields.Add .range(CSV1_NV_COL_ID & "1",CSV1_NV_COL_ID & lastRow), xlSortOnValues, xlDescending , "extreme,high,moderate,low", xlSortNormal
...
On Error Resume Next
	...
	With XLAPP.Workbooks(finalFileName).Worksheets(tab_qr_evolution)
		...
		.range("I1").Value = reportGenerationDate
		...
		lastQRRow = numberOfQR + S1_FIRST_LINE_NUM - 1 'lastQRRow = 	.range("A" & S1_FIRST_LINE_NUM).End(xlDown).Row
